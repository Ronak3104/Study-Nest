...
export const getUserBookings = async (req, res) => {
  try {
    console.log('=== /api/booking/my DEBUG START ===');
    ...
    const { userId } = getAuth(req) || {};
    console.log('Clerk getAuth userId:', userId || 'MISSING');
    ...
    console.log('Querying DB for clerkUserId:', userId);
    ...
    console.log('=== /api/booking/my DEBUG END ===');
    return res.json({
      success: true,
      bookings,
    });
  } catch (err) {
    console.error('=== /api/booking/my ERROR ===');
