...
export const bannerStyles = {
  ...
  // Badge
  badge:
    "inline-flex items-center gap-2 px-4 py-2 bg-blue-100 text-blue-600 rounded-full text-sm font-semibold animate-fade-in",
  badgeIcon: "w-4 h-4 text-blue-500",

  // Heading
  heading:
    "text-3xl sm:text-4xl lg:text-5xl font-Montserrat font-heading uppercase tracking-wider leading-tight",
  headingSpan1:
  ...
  // Description
  description:
    "text-lg sm:text-xl font-body italic font-Roboto font-semibold text-gray-700 leading-relaxed mt-2 sm:mt-4",
  ...
  buttonGetStarted:
    "px-6 py-3 sm:px-8 sm:py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold rounded-xl shadow-lg hover:shadow-blue-200 transition-all duration-300 transform text-sm sm:text-base text-center",
  buttonViewDemo:
    "px-6 py-3 sm:px-8 sm:py-3 bg-white cursor-pointer text-gray-700 font-semibold rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 transform text-sm sm:text-base text-center",
...
export const aboutUsStyles = {
  ...
  // DotLottie container needs explicit size so the player/canvas is visible
  sectionLottie: "w-full h-[220px] sm:h-[260px] md:h-[300px] lg:h-[330px] flex items-center justify-center",
  ...
  teamGrid: "grid md:grid-cols-2 lg:grid-cols-3 gap-8",
...
export const myCoursesStyles = {
  // Layout and container styles
  pageContainer:
    "min-h-screen pt-25 bg-gradient-to-br from-blue-50 to-indigo-100 py-8 font-[pacifico]",
  ...
  courseImage:
    "w-full h-48 object-contain pb-7.5 lg:pb-6 xl:pb-8.5 md:object-cover transition-transform duration-700",
  courseContent: "p-5",
