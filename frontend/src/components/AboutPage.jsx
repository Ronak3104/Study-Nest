...
const AboutPage = () => {
  ...
  }, []); // it will start with less to  final value and then increase to final value in 2 seconds
    ...
    <div className={aboutUsStyles.container}>
      <section className={aboutUsStyles.heroSection}>
        ...
        <div className={aboutUsStyles.heroContent}>
          ...
          <h1 className={aboutUsStyles.mainHeading}>About Study Nest</h1>
          <p className={aboutUsStyles.subHeading}>
            Empowering millions to achieve their dreams through
            <span className={aboutUsStyles.inlineHighlight}>
              quality education and personalized learning experiences.
            </span>
          </p>
          <h1 className={aboutUsStyles.mainHeading}>Our Goal</h1>
        ...
        <div className={aboutUsStyles.sectionGrid}>
          <div className={aboutUsStyles.teamHeader}>
            <h2 className={aboutUsStyles.teamTitle}>
              Meet the Team Behind Study Nest
            </h2>
            <p className={aboutUsStyles.teamSubtitle}>
              A passionate group of educators, technologists, and visionaries
              dedicated to transforming education for everyone.
            </p>
          </div>
      ...
      <section className={aboutUsStyles.ctaSection}>
        ...
        <div className={aboutUsStyles.ctaContent}>
          <h2 className={aboutUsStyles.ctaTitle}>
            Join the Study Nest Community Today!
          </h2>
