...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappUrl = `https://wa.me/919323202788?text=${whatsappMessage}`;
      ...
      <div className={contactStyles.mainContainer}>
                ...
                <div className={contactStyles.formGrid}>
                  <div className={contactStyles.formGroup}>
                    <label className={contactStyles.label}>
                      <User
                        className={`${contactStyles.labelIcon} 
        ...
        <div className={contactStyles.footer}>
          <div className={contactStyles.footerBadge}>
            ...
            <span className={contactStyles.fotterText}>
              All messages are sent directly to our WhatsApp.
